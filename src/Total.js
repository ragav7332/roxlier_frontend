...
//         <Select value={month} onChange={handleMonthChange} sx={{ width: 150, mr: 2 }}>
...
//           sx={{ flexGrow: 1 }}
//         />
//         <Button variant="contained" onClick={handleDownload} disabled={isLoading} sx={{ ml: 2 }}>
//           Download
//         </Button>
//       </div>
//       {isLoading ? (
...
//                     const transactionDate = new Date(transaction.dateOfSale); // Parse the date string
//                     return (
...
//                         <TableCell>{transactionDate.toLocaleDateString()}</TableCell>
...
//         <ResponsiveContainer width="100%" height={300} sx={{ my: 4 }}>
//           <PieChart>
//             <Tooltip />
//             <Legend />
//             <Pie
...
function TransactionTable() {
  ...
  useEffect(() => {
    ...
    // If no search results, show all transactions
